...
class OpenaiAdapter(
    ...
    private val systemMsg = """
        ...
        문체 규칙 (토스 UX 라이팅 스타일):
        - 반드시 해요체로 작성하세요. (예: "~해요", "~했어요", "~이에요")
        - 능동형 표현을 사용하세요. 수동형("~됩니다", "~되었습니다") 대신 능동형("~해요", "~했어요")을 쓰세요.
        - 긍정형 문장을 사용하세요. "안 돼요", "없어요" 대신 긍정적으로 표현하세요.
        - 과도한 경어("~하십시오", "~됩니다")를 쓰지 마세요. 친근하고 캐주얼한 톤을 유지하세요.
        - 명사 나열 대신 동사형으로 풀어 쓰세요.
    """.trimIndent()
